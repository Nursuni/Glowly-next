					...
					<Stack className="description-box">
						...
						{insertProductData.variants.map((variant, idx) => (
							<Stack
								...
								sx={{ border: '1px solid #eee', p: 2, borderRadius: 1, mb: 1 }}
							>
								<Stack direction="row" justifyContent="space-between" alignItems="center" mb={1}>
									<Typography className="title">Variant #{idx + 1}</Typography>
									<Button size="small" color="error" onClick={() => removeVariant(idx)}>
										Remove
									</Button>
								</Stack>
								...
								<Stack className="config-row">
									...
									<Stack className="price-year-after-price">
										<Typography className="title">Hex Color</Typography>
										<Stack direction="row" spacing={1} alignItems="center">
											<input
												type="color"
												value={variant.hexCode || '#ffffff'}
												style={{ width: 40, height: 36, padding: 2, cursor: 'pointer' }}
												onChange={(e) => updateVariant(idx, 'hexCode', e.target.value)}
											/>
											<input
												type="text"
												className="description-input"
								...
								<Stack className="config-row">
									...
									<Stack className="price-year-after-price">
										<Typography className="title">SKU</Typography>
										<input
											type="text"
											className="description-input"
									...
									<Stack className="price-year-after-price">
										<Typography className="title">Active</Typography>
										<select
											className="select-description"
											value={variant.isActive ? 'yes' : 'no'}
											onChange={(e) => updateVariant(idx, 'isActive', e.target.value === 'yes')}
										>
